...
pqxx::result CommentModel::GetComments(int page, std::string query){
...
boost::property_tree::ptree CommentModel::GetCommentsJson(int page, std::string query){
	pqxx::result R = GetComments(page, query);
