...
pqxx::result RateModel::GetRates(int page, std::string query){
...
boost::property_tree::ptree RateModel::GetRatesJson(int page, std::string query){
	pqxx::result R = GetRates(page, query);
