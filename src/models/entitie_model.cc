...
pqxx::result EntitieModel::GetEntities(int page, std::string query){
...
boost::property_tree::ptree EntitieModel::GetEntitiesJson(int page, std::string query){
	pqxx::result R = GetEntities(page, query);
