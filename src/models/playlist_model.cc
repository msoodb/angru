...
pqxx::result PlaylistModel::GetPlaylists(int page, std::string query){
...
boost::property_tree::ptree PlaylistModel::GetPlaylistsJson(int page, std::string query){
	pqxx::result R = GetPlaylists(page, query);
