...
pqxx::result TagModel::GetTags(int page, std::string query){
...
boost::property_tree::ptree TagModel::GetTagsJson(int page, std::string query){
	pqxx::result R = GetTags(page, query);
