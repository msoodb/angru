...
pqxx::result UsersPublisherModel::GetUsersPublishers(int page, std::string query){
...
boost::property_tree::ptree UsersPublisherModel::GetUsersPublishersJson(int page, std::string query){
	pqxx::result R = GetUsersPublishers(page, query);
