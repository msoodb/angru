...
pqxx::result UsersSecurityRoleModel::GetUsersSecurityRoles(int page, std::string query){
...
boost::property_tree::ptree UsersSecurityRoleModel::GetUsersSecurityRolesJson(int page, std::string query){
	pqxx::result R = GetUsersSecurityRoles(page, query);
