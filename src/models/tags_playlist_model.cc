...
pqxx::result TagsPlaylistModel::GetTagsPlaylists(int page, std::string query){
...
boost::property_tree::ptree TagsPlaylistModel::GetTagsPlaylistsJson(int page, std::string query){
	pqxx::result R = GetTagsPlaylists(page, query);
