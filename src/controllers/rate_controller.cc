...
void RateController::doGetRates(const Pistache::Rest::Request& request,
  Pistache::Http::ResponseWriter response) {
    ...
    boost::property_tree::ptree rates = angru::mvc::model::RateModel::GetRatesJson(page, limit, filter, order);
...
void RateController::doAddRate(const Pistache::Rest::Request& request,
  Pistache::Http::ResponseWriter response) {
    ...
    try
    {
      ...
      std::string id = angru::mvc::model::RateModel::AddRate(
                                                  member,
                                                  content,
                                                  rate,
                                                  created_by,
                                                  ...
                                                  situation,
                                                  description );
      std::string message = "{\"message\":\"Rate Added.\", \"id\":\"" + id + "\"}";
