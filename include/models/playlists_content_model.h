...
public:
	...
	~PlaylistsContentModel();
	static pqxx::result GetPlaylistsContents(int page=1, std::string query="");
	static int GetPlaylistsContentsCount(std::string query="");
	static boost::property_tree::ptree GetPlaylistsContentsJson(int page=1, std::string query="");
