...
public:
	RateModel();
	~RateModel();
	static pqxx::result GetRates(int page=1, int limit=LIMIT_COUNT, std::string query="", std::string order="");
	static int GetRatesCount(std::string query="");
	static boost::property_tree::ptree GetRatesJson(int page=1, int limit=LIMIT_COUNT, std::string query="", std::string order="");
