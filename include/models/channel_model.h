...
public:
	...
	static pqxx::result GetAllChannels(int page=1, int limit=LIMIT_COUNT, std::string query="", std::string order="");
	static int GetAllChannelsCount(std::string query="");
	static boost::property_tree::ptree GetAllChannelsJson(int page=1, int limit=LIMIT_COUNT, std::string query="", std::string order="");
